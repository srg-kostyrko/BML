const { BaseTag, createSimpleTag } = require('./base');
...
module.exports = {
  int8: createSimpleTag(Int8),
  uint8: createSimpleTag(Uint8),
  int16: createSimpleTag(Int16),
  uint16: createSimpleTag(Uint16),
  int32: createSimpleTag(Int32),
  uint32: createSimpleTag(Uint32),
  float32: createSimpleTag(Float32),
  float64: createSimpleTag(Float64),
};
